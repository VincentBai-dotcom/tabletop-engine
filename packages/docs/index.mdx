...
<div className="relative overflow-hidden">
  <div className="max-w-5xl mx-auto px-6 pt-10 pb-16 lg:pt-16 lg:pb-24 text-center">
    <img src="/logo/icon-light.svg" alt="tableverse-kit" className="block dark:hidden mx-auto h-32 lg:h-48 w-auto mb-10" />
    <img src="/logo/icon-dark.svg" alt="tableverse-kit" className="hidden dark:block mx-auto h-32 lg:h-48 w-auto mb-10" />
